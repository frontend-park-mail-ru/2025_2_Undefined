    ...
    all: (
      <div>
        ...
        <Section title="Размеры кнопок">
          <Button size="xs" icon="edit">XS</Button>
          <Button size="sm" icon="edit">SM</Button>
          <Button size="md" icon="edit">MD</Button>
          <Button size="lg" icon="edit">LG</Button>
          <Button size="xl" icon="edit">XL</Button>
        </Section>
        ...
        <Section title="Состояния кнопок">
          ...
          <Button variant="secondary" disabled>Неактивная вторичная</Button>
          <Button loading>Загрузка...</Button>
          <Button icon="search" loading>Поиск...</Button>
        </Section>

        {/* Иконки */}
        <Section title="Кнопки с иконками">
          <Button icon="edit">Редактировать</Button>
          <Button icon="search" iconPosition="right">Поиск</Button>
          <Button icon="userAdd">Добавить контакт</Button>
          <Button icon="delete" variant="secondary">Удалить</Button>
        </Section>
      </div>
    ),
    ...
    sizes: (
      <div>
        ...
        <Section title="С иконками">
          <Button size="xs" icon="edit">XS с иконкой</Button>
          <Button size="sm" icon="edit">SM с иконкой</Button>
          <Button size="md" icon="edit">MD с иконкой</Button>
          <Button size="lg" icon="edit">LG с иконкой</Button>
          <Button size="xl" icon="edit">XL с иконкой</Button>
        </Section>
      </div>
    ),
    ...
    states: (
      <div>
        <Section title="Disabled состояния">
          ...
          <Button icon="edit" disabled>С иконкой disabled</Button>
        </Section>

        <Section title="Loading состояния">
          <Button loading>Загрузка...</Button>
          <Button variant="primary" loading>Primary загрузка</Button>
          <Button variant="secondary" loading>Secondary загрузка</Button>
          <Button icon="search" loading>Поиск...</Button>
        </Section>
    ...
    icons: (
      <div>
        ...
        <Section title="Размеры иконок">
          <Button icon="edit" iconSize="xs">XS иконка</Button>
          <Button icon="edit" iconSize="sm">SM иконка</Button>
          <Button icon="edit" iconSize="md">MD иконка</Button>
          <Button icon="edit" iconSize="lg">LG иконка</Button>
          <Button icon="edit" iconSize="xl">XL иконка</Button>
        </Section>

        <Section title="Позиции иконок">
          <Button icon="exit" iconPosition="left">Выйти (слева)</Button>
          <Button icon="exit" iconPosition="right">Выйти (справа)</Button>
          <Button icon="search" iconPosition="left">Поиск (слева)</Button>
          <Button icon="search" iconPosition="right">Поиск (справа)</Button>
        </Section>
      </div>
    ),
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <Button 
          variant={activeTab === 'practical' ? 'primary' : 'secondary'}
          size="sm"
